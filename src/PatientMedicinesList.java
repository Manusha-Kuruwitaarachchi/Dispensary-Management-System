...
public class PatientMedicinesList {
    ...
    public void Node(int patientid, String name, String health, String medicines){
     ...
     public void insertPatient(int patientid, String name, String health, String medicines){
        Node temp = head;
        boolean cantFound = false;
        if(head == null){
            cantFound = true;
            Node(patientid, name, health, medicines);
        }
        else{
